...
MARKETS = {
    "US": {
        ...
        "tickers": [
            ...
            # New Sectors (Aerospace, Industrials, Mining, Apparel)
            "TDG", "HWM", "RKLB", "LHX",          # Aerospace & Space
            "UNP", "WM", "UPS", "FDX", "PH", "ITW",  # Industrials & Logistics
            "BHP", "RIO", "ALB", "MP", "VALE",      # Mining & Raw Materials
            "NKE", "LULU", "TJX", "DECK", "LEVI"    # Apparel & Fashion
        ]
    },
    # NOTE: European markets (ES, FR, DE) are currently commented out.
    # Alpaca API is strictly limited to US securities and ADRs, meaning European exchanges 
    # like BME (Spain), Euronext (France), and Xetra (Germany) are unsupported and will return trading errors.
    # We keep these configurations for future reference. If we integrate a multi-market broker API 
    # (such as Interactive Brokers via ib_insync or XTB xAPI), we can easily uncomment and restore these markets.
    #
    # "ES": {
